...
public class BankCardInfo {
	 ...
	 *
	 */
	public BankCardInfo(Integer bankInfoId, String bankCardNum, String openingBank, Integer cityId, Integer userId,
			Integer bankId, String bankBranch, String reservePhone, String username, String bankName,
			String userRealName) {
		super();
	...
	public String toString() {
		return "BankCardInfo [bankInfoId=" + bankInfoId + ", bankCardNum=" + bankCardNum + ", openingBank="
				+ openingBank + ", cityId=" + cityId + ", userId=" + userId + ", bankId=" + bankId + ", bankBranch="
				+ bankBranch + ", reservePhone=" + reservePhone + ", username=" + username + ", bankName=" + bankName
				+ ", userRealName=" + userRealName + ", province=" + province + ", provinceNum=" + provinceNum
				+ ", city=" + city + ", cityNum=" + cityNum + ", countryNum=" + countryNum + ", country=" + country
				+ ", location=" + location + "]";
	}
