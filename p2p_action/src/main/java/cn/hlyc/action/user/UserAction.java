...
public class UserAction extends BaseAction implements ModelDriven<UserModel> {
	...
	public void saveUser() {
		...
		us.setUserImg("nophoto.jpg");

		// 调用service完成新增操作
		boolean addUserResult = userService.addUser(us);
	...
	public void getUserById() {
		...
		try {
			...
			// 调用service根据id查询
			UserModel us = userService.findById(Integer.parseInt(id));
			if (us == null) {
