...
public class Product {
	...
	public String toString() {
		return "Product [proId=" + proId + ", proNum=" + proNum + ", proTypeId=" + proTypeId + ", upperTimeLimit="
				+ upperTimeLimit + ", lowerTimeLimit=" + lowerTimeLimit + ", earningType=" + earningType
				+ ", wayToReturnMoney=" + wayToReturnMoney + ", earlyRedeptionType=" + earlyRedeptionType
				+ ", closedPeriod=" + closedPeriod + ", status=" + status + ", proUpperInvest=" + proUpperInvest
				+ ", proLowerInvest=" + proLowerInvest + ", investRule=" + investRule + ", productName=" + productName
				+ ", isAllowTransfer=" + isAllowTransfer + ", isRepeatInvest=" + isRepeatInvest
				+ ", IsRepeatInvestDesc=" + IsRepeatInvestDesc + ", earningTypeDesc=" + earningTypeDesc
				+ ", statusDesc=" + statusDesc + ", wayToReturnMoneyDesc=" + wayToReturnMoneyDesc
				+ ", annualInterestRate=" + annualInterestRate + ", modifyTime=" + modifyTime + ", isAllowTransferDesc="
				+ isAllowTransferDesc + ", modifierId=" + modifierId + ", username=" + username + ", typeName="
				+ typeName + ", proType=" + proType + ", proEarningRate=" + proEarningRate + "]";
	}
