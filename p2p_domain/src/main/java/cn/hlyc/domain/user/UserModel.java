...
public class UserModel {
	...
	private int realNameStatus; // 真实姓名验证
	...
	public String toString() {
		return "UserModel [id=" + id + ", userImg=" + userImg + ", username=" + username + ", password=" + password
				+ ", ip=" + ip + ", email=" + email + ", phone=" + phone + ", registerTime=" + registerTime
				+ ", loginTime=" + loginTime + ", randomCode=" + randomCode + ", inviteid=" + inviteid + ", onlock="
				+ onlock + ", remark=" + remark + ", userType=" + userType + ", phoneStatus=" + phoneStatus
				+ ", emailStatus=" + emailStatus + ", realName=" + realName + ", identity=" + identity
				+ ", realNameStatus=" + realNameStatus + ", payPassword=" + payPassword + ", payPwdStatus="
				+ payPwdStatus + ", userSecure=" + userSecure + ", sumFriends=" + sumFriends + "]";
	}
