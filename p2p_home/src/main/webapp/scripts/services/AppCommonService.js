var option = {
    'url':{
        ...
        'api_jiekuan' : '/p2p_action/userLoan/',
        'api_img':'http://192.168.50.128/touxiang/'
    },
    'header':{
        'headers':{
...
angular.module('AppCommonService', ['ngCookies','ui.router'])
        ...
        return {
           ...
           //注册校验验证码的正确性
            ...
            lendSuccess:function($str){
                return $http.post(option.url.api_jiekuan+'saveUserLoan', $str, option.header);
            },
    ...
    .factory('UserService',function ($http,AuthService) {
        return {
            ...
            getUrl :function(){
            	return option.url.api_upload+'uploads';
            },
            
            getImgUrl :function(){
            	return option.url.api_img;
            },
            
            cut :function($str){
            	return $http.post(option.url.api_upload+'cut',$str,option.header);
            },
